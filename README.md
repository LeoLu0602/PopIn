...
- **Web route 404 on refresh (e.g. `/feed`)**: configure SPA fallback rewrites in your host so unknown paths return `index.html` (this repo includes `vercel.json` for Vercel)
